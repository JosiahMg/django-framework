...
class ServiceSourceTrace:
    def __init__(self, info_dict):
        ...
        logger.info(
            f"trace source project_id: {self.project_id}, batch_no: {self.batch_no}, "
            f"start_time: {self.start_time}, topo_id: {self.topo_id}, calc_typ: {self.calc_type}")
    ...
    def check_param(self):
        ...
        if self.info_dict.get("startTime", ""):
            ...
            self.info_dict["startTime"] = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
